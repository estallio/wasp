...
func (c *WaspClient) PutCommitteeRecord(rec *chain.CommitteeRecord) error {
...
func (c *WaspClient) GetCommitteeRecord(addr ledgerstate.Address) (*chain.CommitteeRecord, error) {
