...
pub struct AtomicSwap {
    pub sc_name_sender:     String,
    pub sc_name_recipient:   String,
...
impl AtomicSwap {
    pub fn from_bytes(bytes: &[u8]) -> AtomicSwap {
        ...
        AtomicSwap {
            sc_name_sender: decode.string(),
            sc_name_recipient: decode.string(),
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        encode.string(&self.sc_name_sender);
        encode.string(&self.sc_name_recipient);
